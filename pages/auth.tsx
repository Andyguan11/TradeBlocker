...
function AuthPage({ Component, pageProps }: AppProps) {
  // If we're on the sign-up page, render the SignUpPage component
  // Otherwise, render the default Component (allows for future expansion)
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden max-w-6xl w-full flex">
        ...
        <div className="w-full lg:w-1/2 p-8">
          <div className="flex items-center mb-8">
            ...
            <h1 className="text-2xl font-bold">Basement</h1>
          </div>
          <h2 className="text-3xl font-bold mb-2">Keep your online business organized</h2>
          <p className="text-gray-600 mb-8">Sign up to start your 30 days free trial</p>
          
          <button className="w-full mb-4 flex items-center justify-center border border-gray-300 rounded-md py-2 px-4 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          ...
          <p className="text-center text-gray-600 mt-6">
            Already have an account? <a href="#" className="text-black font-semibold">Login Here</a>
          </p>
        </div>
